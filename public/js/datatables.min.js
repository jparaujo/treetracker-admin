 ...
 *   https://datatables.net/download/#dt/jq-3.2.1/dt-1.10.16/b-1.5.1
 *
 * Included libraries:
 *   jQuery 3 3.2.1, DataTables 1.10.16, Buttons 1.5.1
 */
...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function (callingElement) {
            ...
            var myTable = $(callingElement.closest("table")).DataTable().table();
            ...
            function _update(newValue) {
                ...
                //1-27-2018 mod iremaka - callingElement, table
                //settings.onUpdate(cell, row, oldValue);
                //settings.onUpdate(cell, row, oldValue, callingElement, myTable);
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    //1-27-2018 mod iremaka - 
    //mod_1: handle number input with steps

    var mod1_step = inputSetting.step;
    ...
    switch (inputType) {
        ...
        case "number":
        case "number-confirm":
            input.html = "<input type='number' step='" + mod1_step + "' id='ejbeatycelledit' class='" + inputCss + "' value='" + oldValue + "'>"+""+"</input><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Confirm</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a>";
            break;      
        case "list":
